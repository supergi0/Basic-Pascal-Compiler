...
#line 1 "parser.y"
    ...
    struct data_type {
        ...
        int line_number;
        int is_assigned;
    } symbol_table[200], symbol_table_extra[200], symbol_table_if[200], symbol_table_else[200], symbol_table_for[200], symbol_table_while[200],symbol_table_ex[200];

    void deep_copy_symbol_table(struct data_type src[200], struct data_type dest[200]) {
        memset(dest, 0, sizeof(struct data_type) * 200); // Clear the destination array

        for (int i = 0; i < 200; i++) {
            if (src[i].name != NULL) {
                dest[i].name = malloc(strlen(src[i].name) + 1);
                strcpy(dest[i].name, src[i].name);
            }

            if (src[i].type != NULL) {
                dest[i].type = malloc(strlen(src[i].type) + 1);
                strcpy(dest[i].type, src[i].type);
            }

            if (src[i].value != NULL) {
                dest[i].value = malloc(strlen(src[i].value) + 1);
                strcpy(dest[i].value, src[i].value);
            }

            dest[i].line_number = src[i].line_number;
            dest[i].is_assigned = src[i].is_assigned;
        }
    }
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_write_params = 91,              /* write_params  */
  YYSYMBOL_read_statement = 92             /* read_statement  */
};
...
{
       0,   406,   406,   433,   446,   457,   470,   484,   492,   508,
     518,   528,   538,   547,   556,   582,   602,   611,   630,   642,
     655,   662,   669,   676,   683,   690,   697,   706,   777,   792,
     805,   844,   857,   896,   909,   944,   979,  1014,  1049,  1084,
    1121,  1134,  1152,  1172,  1185,  1203,  1221,  1240,  1279,  1292,
    1315,  1346,  1394,  1403,  1413,  1423,  1431,  1442,  1454,  1460,
    1453,  1496,  1495,  1511,  1517,  1516,  1604,  1603,  1693,  1697,
    1692,  1731,  1754,  1774,  1811,  1836,  1879
};
#endif
...
static const char *const yytname[] =
{
  ...
  "else_statement", "$@3", "for_statement", "$@4", "$@5",
  "while_statement", "$@6", "$@7", "write_statement", "write_params",
  "read_statement", YY_NULLPTR
};
...
static const yytype_uint8 yydefgoto[] =
{
      ...
      65,    66,    29,    67,    30,    31,    79,   129,   134,   137,
      32,   135,   136,    33,    46,   118,    34,    73,    35
};
...
static const yytype_int8 yyr1[] =
{
      ...
      79,    83,    82,    82,    85,    84,    86,    84,    88,    89,
      87,    90,    91,    91,    91,    91,    92
};
...
#line 806 "parser.y"
    {
        ...
        if((yyvsp[-2].nd_obj).integer_val==1 || (yyvsp[0].nd_obj).integer_val==1){
            (yyval.nd_obj).integer_val = 1;
        }
        else{
            (yyval.nd_obj).integer_val = 0;
        }
    }
#line 2269 "y.tab.c"
    break;
...
#line 910 "parser.y"
    {
        ...
        if((yyvsp[-2].nd_obj).integer_val < (yyvsp[0].nd_obj).integer_val){
            (yyval.nd_obj).integer_val = 1;
        }
        else{
            (yyval.nd_obj).integer_val = 0;
...
#line 1135 "parser.y"
    {
        ...
        (yyval.nd_obj).integer_val = (yyvsp[-2].nd_obj).integer_val + (yyvsp[0].nd_obj).integer_val;
        (yyval.nd_obj).real_val = (yyvsp[-2].nd_obj).real_val + (yyvsp[0].nd_obj).real_val;
    }
#line 2606 "y.tab.c"
    break;
...
#line 1316 "parser.y"
    {
        ...
        for (int i = 0; i < count; i++) {
            if (strcmp(symbol_table[i].name, (yyvsp[0].nd_obj).nd->children[0]->token) == 0) {
                if((yyval.nd_obj).type == 1){
                    (yyval.nd_obj).integer_val = atoi(symbol_table[i].value);
                }
                if((yyval.nd_obj).type == 2){
                    (yyval.nd_obj).real_val = atof(symbol_table[i].value);
                }
                if((yyval.nd_obj).type == 3){
                    (yyval.nd_obj).character_val = symbol_table[i].value[0];
                }
            }
        }
...
#line 1347 "parser.y"
    {
        ...
        for (int i = 0; i < count; i++) {
            char buffer[256];
            sprintf(buffer,"%s[%d]",(yyvsp[-3].nd_obj).nd->children[0]->token,(yyvsp[-1].nd_obj).integer_val);
            if (strcmp(buffer, symbol_table[i].name) == 0) {
                if((yyval.nd_obj).type == 1){
                    (yyval.nd_obj).integer_val = atoi(symbol_table[i].value);
                }
                if((yyval.nd_obj).type == 2){
...
#line 1454 "parser.y"
    {
        ...
        deep_copy_symbol_table(symbol_table,symbol_table_extra);
    }
#line 2953 "y.tab.c"
    break;
...
#line 1460 "parser.y"
    {
        ...
        deep_copy_symbol_table(symbol_table,symbol_table_if);
    }
#line 2963 "y.tab.c"
    break;
...
#line 1466 "parser.y"
    {
        ...
        if((yyvsp[-5].nd_obj).integer_val==1){
            deep_copy_symbol_table(symbol_table_if,symbol_table);
        }
        else{
            deep_copy_symbol_table(symbol_table_else,symbol_table);
        }
...
#line 1496 "parser.y"
{
    deep_copy_symbol_table(symbol_table_extra,symbol_table);
}
#line 3002 "y.tab.c"
    break;

  case 62: /* else_statement: T_ELSE $@3 compound_statement  */
#line 1499 "parser.y"
{
    (yyval.nd_obj).nd = mknode("else_statement");

    (yyvsp[-2].nd_obj).nd = mknode("ELSE");
    (yyvsp[-2].nd_obj).nd->children[0] = mknode((yyvsp[-2].nd_obj).name);

    (yyval.nd_obj).nd->children[0] = (yyvsp[-2].nd_obj).nd;
    (yyval.nd_obj).nd->children[1] = (yyvsp[0].nd_obj).nd;

    deep_copy_symbol_table(symbol_table,symbol_table_else);
}
#line 3018 "y.tab.c"
    break;

  case 63: /* else_statement: %empty  */
#line 1511 "parser.y"
{
...
#line 1517 "parser.y"
    {
        deep_copy_symbol_table(symbol_table,symbol_table_ex);
...
#line 3074 "y.tab.c"
  ...
  case 65: /* for_statement: T_FOR identifier ASSIGNMENT expression TO expression T_DO $@4 compound_statement  */
#line 1561 "parser.y"
    {
        deep_copy_symbol_table(symbol_table,symbol_table_for);
        ...
        if((yyvsp[-5].nd_obj).integer_val <= (yyvsp[-3].nd_obj).integer_val){
            deep_copy_symbol_table(symbol_table_for,symbol_table);
        }
        else{
            deep_copy_symbol_table(symbol_table_ex,symbol_table);
        }
...
#line 3168 "y.tab.c"
  ...
  case 67: /* for_statement: T_FOR identifier ASSIGNMENT expression DOWNTO expression T_DO $@5 compound_statement  */
#line 1648 "parser.y"
    {
        deep_copy_symbol_table(symbol_table,symbol_table_for);
...
#line 3232 "y.tab.c"
  ...
  case 70: /* while_statement: T_WHILE $@6 expression T_DO $@7 compound_statement  */
#line 1703 "parser.y"
    {
        ...
        if((yyvsp[-3].nd_obj).integer_val==1){
...
#line 3262 "y.tab.c"
  ...
  case 71: /* write_statement: WRITE LPAREN write_params RPAREN  */
#line 1732 "parser.y"
    {
...
#line 1755 "parser.y"
    {
        ...
        char *token_copy = strdup((yyvsp[0].nd_obj).nd->children[0]->token);
        if (token_copy[0] == '\"') {
...
#line 3309 "y.tab.c"
  ...
  case 73: /* write_params: identifier  */
#line 1775 "parser.y"
    {
        (yyval.nd_obj).nd = mknode("write_params");
...
#line 3349 "y.tab.c"
  ...
  case 74: /* write_params: write_params COMMA T_STRING  */
#line 1812 "parser.y"
    {
        (yyval.nd_obj).nd = mknode("write_params");
...
#line 3377 "y.tab.c"
  ...
  case 75: /* write_params: write_params COMMA identifier  */
#line 1837 "parser.y"
    {
        (yyval.nd_obj).nd = mknode("write_params");
...
#line 3421 "y.tab.c"
  ...
  case 76: /* read_statement: READ LPAREN identifier_or_array RPAREN  */
#line 1880 "parser.y"
    {
        ...
        for (int i = 0; i < count; i++) {
            char buffer[256];
            if((yyvsp[-1].nd_obj).is_array==0){
                strcpy(buffer,(yyvsp[-1].nd_obj).nd->children[0]->children[0]->token);
            }
            else{
                sprintf(buffer,"%s[%d]",(yyvsp[-1].nd_obj).nd->children[0]->children[0]->token,(yyvsp[-1].nd_obj).array_index);
            }
            if (strcmp(symbol_table[i].name,buffer) == 0) {
                symbol_table[i].is_assigned = 1;
                char buffer2[226];
                scanf("%s",buffer2);
                strcpy(symbol_table[i].value,buffer2);
                break;
            }
        }
